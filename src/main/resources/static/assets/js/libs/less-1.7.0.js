...
// Node.css does not have a header file added which defines less
if (less === undefined) {
    less = exports;
    tree = require('./tree');
    less.mode = 'node';
...
less.Parser = function Parser(env) {
    ...
    parser = {
        ...
        parsers: parsers = {
            ...
            // we deal with this in *combinator.css*.
            //
            combinator: function () {
...
tree.Call.prototype = {
    ...
    //
    // The *functions.css* file contains the built-in functions.
    //
...
//
// browser.css - client-side engine
//
